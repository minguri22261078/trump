...
const MemeSection = () => {
    ...
    // 실제 차트에 표시할 전체 데이터 (억 단위, NASDAQ-100 성장 반영, 2018~2020 점진적 상승 → 2021년 약간 하락 → 2022~2023 강한 반등)
    const fullData = [720, 800, 950, 900, 1150, 1430];
    ...
    return (
        <Wrapper>
            ...
            <FullScreenTitleSection>
                <Title>미국 나스닥 100</Title>
            </FullScreenTitleSection>

            {/* 히어로 이미지 배경 영역 및 오버레이 텍스트 */}
            <HeroSection>
                <OverlayLabel>Top 1📈</OverlayLabel>
            </HeroSection>
            ...
            <Section>
                ...
                <Change>-5.1% : -107,000</Change>
            </Section>

            {/* 차트 및 설명 영역 */}
            <HeroLinear>
                <HeadlineLarge>Innovate. Disrupt. Dominate.</HeadlineLarge>
                <HeadlineLarge style={{ marginTop: "-12px" }}>The NASDAQ-100 Revealed.</HeadlineLarge>
                <SubText>미국 기술 주식의 정수, NASDAQ-100 지수를 시각적으로 분석해드립니다.</SubText>
...
const HeroSection = styled.div`
  height: 40vh;
  background-image: url('/img/nifty-hero3.png');
